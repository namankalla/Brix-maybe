      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-background via-card to-background">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold tracking-tight">AppForge</span>
          </div>
          
          <h1 className="text-4xl font-bold text-center mb-4">
            <span className="gradient-text">Build apps</span> with
            <br />
            conversation
          </h1>
          
          <p className="text-muted-foreground text-center text-lg max-w-md">
            Describe your app idea in plain English. Our AI understands your vision and generates production-ready code.
          </p>
